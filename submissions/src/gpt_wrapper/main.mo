...
actor {
  ...
  public func greet(name : Text) : async Text {
    ...
    let host : Text = "api.upstage.ai";
    let url : Text = "https://api.upstage.ai/v1/solar/chat/completions"; //HTTP that accepts IPV6
    ...
    let request_headers = [
        ...
        { name= "Authorization"; value = "Bearer [Upstage API Key]" }
    ];
    ...
    let request_body_json: Text = "{  \"model\": \"solar-1-mini-chat\",  \"messages\": [    {      \"role\": \"system\",      \"content\": \"You are a helpful assistant.\"    },    {      \"role\": \"user\",      \"content\": \"" # name # "\"    }  ],  \"stream\": true}";
