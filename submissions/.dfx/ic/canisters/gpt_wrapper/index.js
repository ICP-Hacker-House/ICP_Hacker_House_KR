...
import { idlFactory } from './gpt_wrapper.did.js';
export { idlFactory } from './gpt_wrapper.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GPT_WRAPPER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gpt_wrapper.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gpt_wrapper canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gpt_wrapper.did.js")._SERVICE>}
 */
export const gpt_wrapper = createActor(canisterId);
